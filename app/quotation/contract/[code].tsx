  ...
  const handleExternalOpen = async () => {
    ...
    try {
      ...
      if (supported) {
        ...
        Alert.alert('Error', 'Cannot open the contract file');
      }
    } catch (error) {
      console.error('Error opening contract file:', error);
      Alert.alert('Error', 'Failed to open contract file');
    }
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.section, { backgroundColor: colors.card }]}>
          <View style={styles.contractHeader}>
            ...
            <Ionicons name={getStatusIcon(contract.status) as keyof typeof Ionicons.glyphMap} size={14} color={statusColor} style={styles.statusIcon} />
        ...
        {/* Status section */}
        {/* <View style={[styles.section, { backgroundColor: colors.card }]}>
          <Text style={[styles.sectionTitle, { color: colors.text }]}>Contract Status</Text>
          
          <View style={styles.statusRow}>
            <View style={styles.statusItem}>
              <Ionicons 
                name={contract.isSigned ? "checkmark-circle" : "ellipse-outline"} 
                size={24} 
                color={contract.isSigned ? CONTRACT_COLOR : colors.textSecondary} 
              />
              <Text style={[styles.statusItemText, { color: colors.text }]}>Signed</Text>
            </View>
            
            <View style={styles.statusItem}>
              <Ionicons 
                name={contract.isDeposited ? "checkmark-circle" : "ellipse-outline"} 
                size={24} 
                color={contract.isDeposited ? CONTRACT_COLOR : colors.textSecondary} 
              />
              <Text style={[styles.statusItemText, { color: colors.text }]}>Deposited</Text>
            </View>
            
            <View style={styles.statusItem}>
              <Ionicons 
                name={contract.isFinalPaid ? "checkmark-circle" : "ellipse-outline"} 
                size={24} 
                color={contract.isFinalPaid ? CONTRACT_COLOR : colors.textSecondary} 
              />
              <Text style={[styles.statusItemText, { color: colors.text }]}>Fully Paid</Text>
            </View>
          </View>
        </View> */}
